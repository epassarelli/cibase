...
<section class="content-header">
    <h1>
        ...
        <input type="text" id="tipocat" name="tipocat" value="<?php echo set_value('tipocat',$tipocat); ?>">
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalTitle"><span class="titulo"></span>Categorias</h4>
            </div>
