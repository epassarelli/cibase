								...
								<?php if (parametro(1) == 'S') : ?>
									<form enctype="multipart/form-data" method="post" class="cart">
										<div class="quantity quantity-lg">
											<input type="button" class="minus" value="-" onclick="restaritem(<?php echo $producto->unidadvta ?>)">
											...
											<input type="button" class="plus" value="+" onclick="sumaritem(<?php echo $producto->unidadvta ?>)">
										</div>
