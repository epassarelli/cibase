	...
	<td class="product-quantity">
		<form enctype="multipart/form-data" method="post" class="cart">
			<div class="quantity">
				...
				<input type="text"   onchange="cambiaCarro2($(this).val(),<?php echo $_SESSION['carrito'][$i]['codigo']; ?>,$(this))" class="input-text qty text" title="Qty" value="<?php echo $_SESSION['carrito'][$i]['cantidad']; ?>" name="quantity" min="1" step="1">
