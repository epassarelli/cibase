...
class Contenidos extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Secciones_model', 'Bloques_model', 'Componentes_model', 'productos/Productos_model'));
    }
    ...
    public function pagina($slug = '')
    {
        ...
        if ($seccion) {
            ...
            if (strlen($seccion->bajada) >= 5) {
                ...
                // Kouro - Si la seccion es la de Inicio traigo los destacados
                if ($seccion->seccion_id == 4) {

                    $destacados = $this->Productos_model->getDestacados();
