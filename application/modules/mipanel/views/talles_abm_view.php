...
<section class="content-header">
    <h1>
        Talles
        <small>Listado de Talles</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <!-- <li><a href="#">Tables</a></li> -->
        <li class="active">Talles</li>
    </ol>
</section>
<!-- Main content -->
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <p>
                        <button type="button" class="btn btn-primary margin insertar" data-toggle="modal" data-target="#modalTalles"><i class='fa fa-plus-circle fa-lg'></i>    Insertar </button>
                       
                    </p>
                    <table id="tallesAbm" class="table table-bordered">
                        <thead>
                            <tr>
...
<div class="modal fade" id="modalTalles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="sent" class="col-3"></div>
                <form action="<?php echo base_url('mipanel/talles/accion');?>" id="formTalles" method="post" enctype="multipart/form-data">
