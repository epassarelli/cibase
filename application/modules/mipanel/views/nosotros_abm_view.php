<section class="content-header">
    <h1>
        Nosotros
        <small>Listado de nosotros</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <p>
                        <button type="button" class="btn btn-primary margin insertar" data-toggle="modal" data-target="#modalNosotros"><i class='fa fa-plus-circle fa-lg'></i>    Insertar </button>
                    </p>
                    <table id="nosotrosAbm" class="table table-bordered">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Titulo</th>
...
<div class="modal fade" id="modalNosotros" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modalTitle"><span class="titulo"></span> Nosotros</h4>
            </div>
